                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-2 align-top">
                                                <div class="flex space-x-2">
                                                    <button type="button" onclick="openDocPreview('{{ route('documents.serve', $document) }}', '{{ route('documents.download', $document) }}', '{{ addslashes(ucfirst(str_replace('_', ' ', $document->document_type))) }}')" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700" title="Ver">
