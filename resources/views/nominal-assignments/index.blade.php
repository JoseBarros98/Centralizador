<x-app-layout>
                ...
                <form method="GET" action="{{ route('nominal-assignments.index') }}" id="programForm" class="flex-1 min-w-0 relative" @submit.prevent>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            class="w-full border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:ring-2 focus:ring-gray-800 focus:border-gray-800"
                        >
                ...
                <div class="flex-shrink-0 min-w-[180px]">
                    ...
                    <div class="relative">
                        ...
                        <select onchange="applyResponsableFilter(this.value)"
                            class="w-full border border-gray-300 rounded-lg pl-10 pr-3 py-2 text-sm focus:ring-2 focus:ring-gray-800 focus:border-gray-800 appearance-none">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="participantSearch"
                        ...
                        class="w-full border border-gray-300 rounded-lg pl-10 pr-9 py-1.5 text-sm focus:ring-2 focus:ring-gray-800 focus:border-gray-800">
    ...
    async function refreshAssignment(assignmentId) {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Siempre recargar: los saldos pueden haber cambiado aunque no haya inscritos nuevos
    ...
    function startEdit(el, field, detailId, currentVal) {
        ...
        // Cobrado: input vací­o - el usuario ingresa solo el nuevo pago recibido
    ...
    async function commitEdit(field, detailId) {
        ...
        // Si es cobrado y el campo está vací­o, no enviar nada
        if (isCobrado && !rawVal) {
