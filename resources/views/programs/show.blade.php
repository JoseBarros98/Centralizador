<x-app-layout>
    ...
    <div >
        <div class="w-full sm:px-6 lg:px-8">
            ...
            <!-- Acciones Rápidas -->
            @if(auth()->user()->can('inscription.view') || auth()->user()->can('program.view'))
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead>
                                <tr class="bg-gray-800 text-white text-xs">
                                    ...
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Docente</th>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Monitor</th>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Fechas</th>
