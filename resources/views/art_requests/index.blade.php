                    ...
                    <form method="GET" action="{{ route('art_requests.index') }}" class="space-y-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-end md:justify-between w-full gap-4">
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('art_requests.kanban', request()->only('date_from','date_to','designer_id')) }}"
                                   class="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-100 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200 transition ease-in-out duration-150">
                        ...
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead>
                                <tr class="bg-gray-800 text-white text-xs">
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Solicitante</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Diseñador</th>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Prioridad</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Fecha Entrega</th>
                                </tr>
                            </thead>
