                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('programs.modules.store', $program->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="relative">
                                <label for="teacher_search" class="block text-sm font-medium text-gray-700">
                                    Nombre del Docente
                                    <button type="button" onclick="openCreateTeacherModal()" class="ml-2 text-indigo-600 hover:text-indigo-900 text-xs">
                                        + Nuevo docente
                                    </button>
                                </label>
                                <input type="text" 
                                ...
                                <div id="teacher_results" class="hidden absolute z-10 w-full bg-white shadow-lg rounded-md mt-1 max-h-60 overflow-auto border border-gray-200"></div>
                            ...
                            <div>
                                ...
                                <x-input id="finalization_date" class="block mt-1 w-full" type="date" name="finalization_date" :value="old('finalization_date')" required />
                            ...
                            <div >
                                ...
                                <select id="status" name="status" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    ...
                                    <option value="Desarrollo" {{ old('status') == 'Desarrollo' ? 'selected' : '' }}>Desarrollo</option>
