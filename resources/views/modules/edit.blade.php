                    ...
                    <form method="POST" action="{{ route('programs.modules.update', [$program->id, $module->id]) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="class_count" class="block mt-1 w-full" type="number" name="class_count" :value="old('class_count', $module->class_count)" min="1" required />
                                @error('class_count')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <label for="active" class="inline-flex items-center">
                                    <input id="active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="active" value="1" {{ old('active', $module->active) ? 'checked' : '' }}>
