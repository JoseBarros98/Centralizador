...
.status-inactive { background-color: #fecaca; color: #991b1b; }
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-base">{{ $typeOfArt->name }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-base">{{ $typeOfArt->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                            @if($typeOfArt->updated_by)
                            <div>
                                <p class="text-sm font-medium text-gray-500">Actualizado por:</p>
                                <p class="text-base">{{ $typeOfArt->updater->name ?? 'Desconocido' }}</p>
                            </div>
                            <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    <a href="{{ route('type_of_arts.files.serve', $file) }}" download class="text-green-600 hover:text-green-900" title="Descargar">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div id="upload-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 hidden modal-overlay">
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
            ...
            <form id="upload-form" action="{{ route('type_of_arts.files.upload', $typeOfArt) }}" method="POST" enctype="multipart/form-data">
                @csrf
