<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">Editar Rol: {{ ucfirst($role->name) }}</h2>
    </x-slot>
    ...
    <div>
        <div class="w-full sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-end gap-2 mb-4">
                <a href="{{ route('roles.show', $role) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none transition">
            ...
            <form method="POST" action="{{ route('roles.update', $role) }}">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <div class="max-w-sm">
                            ...
                            @if($role->name === 'admin')
                                <p class="mt-1 text-xs text-gray-500">El nombre del rol de administrador no puede modificarse.</p>
                            @endif
                            @error('name')
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('roles.show', $role) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-50 focus:outline-none transition">
                        Cancelar
                    </a>
