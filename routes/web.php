...
Route::middleware('auth')->group(function () {
  ...
  Route::get('art-requests/{artRequest}/comments/latest', [ArtRequestCommentController::class, 'latest'])->name('art-requests.comments.latest');
  ...
  Route::prefix('accounting')->name('nominal-assignments.')->group(function () {
      ...
      Route::patch('/nominal-assignments/detail/{detail}/toggle-hidden', [NominalAssignmentController::class, 'toggleHidden'])->name('detail.toggle-hidden');
